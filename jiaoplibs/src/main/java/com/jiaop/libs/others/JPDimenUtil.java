...
/**
 * Created by JiaoP
 * 选定基准分辨率大小，生成其他分辨率的dimen.xml文件工具类
 * lay_x.xml 宽度距离
 * lay_y.xml 高度距离
 */
public class JPDimenUtil {
    ...
    public JPDimenUtil(int baseX, int baseY, String supportStr) {
        this.baseW = baseX;
        this.baseH = baseY;
    ...
    public static void main(String[] args) {
        ...
        new JPDimenUtil(baseW, baseH, addition).generate();
    }
