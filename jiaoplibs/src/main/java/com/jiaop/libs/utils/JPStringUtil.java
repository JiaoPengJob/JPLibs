...
public class JPStringUtil {
    ...
    public static String byte2FitSize(long byteNum) {
        ...
        } else if (byteNum < JPConstUtil.KB) {
            return String.format(Locale.getDefault(), "%.3fB", (double) byteNum);
        } else if (byteNum < JPConstUtil.MB) {
            return String.format(Locale.getDefault(), "%.3fKB", (double) byteNum / JPConstUtil.KB);
        } else if (byteNum < JPConstUtil.GB) {
            return String.format(Locale.getDefault(), "%.3fMB", (double) byteNum / JPConstUtil.MB);
        } else {
            return String.format(Locale.getDefault(), "%.3fGB", (double) byteNum / JPConstUtil.GB);
        }
    }
