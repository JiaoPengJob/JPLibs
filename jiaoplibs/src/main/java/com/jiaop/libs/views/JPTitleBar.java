...
public class JPTitleBar extends ViewGroup implements View.OnClickListener {
    ...
    public JPTitleBar(Context context) {
        super(context);
        init(context);
    }

    public JPTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public JPTitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        mActionPadding = JPUIUtil.dp2PxInt(context, 5f);
        mOutPadding = JPUIUtil.dp2PxInt(context, 8f);
        mHeight = JPUIUtil.dp2PxInt(context, DEFAULT_TITLE_BAR_HEIGHT);
        initView(context);
    }
